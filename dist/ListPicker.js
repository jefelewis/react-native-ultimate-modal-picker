...
const ListPicker = ({ defaultValue, items, onChange, title, style = {
    container: {},
    modal: {},
    modalContainer: {},
    ...
    const renderIOSPicker = () => {
        return (react_1.default.createElement(picker_1.Picker, { selectedValue: tempItem !== undefined ? tempItem : item, onValueChange: (item) => selectItem(item) }, items.map((item) => {
        ...
        // Check Platform (Android)
            ...
            return (react_1.default.createElement(react_native_1.View, { style: {
                ...
                react_1.default.createElement(react_native_1.View, { style: {
                    ...
                    react_1.default.createElement(picker_1.Picker, { selectedValue: item, style: { height: 60, width: width - 16 }, onValueChange: (item) => selectItem(item), mode: "dropdown" }, items.map((item) => {
