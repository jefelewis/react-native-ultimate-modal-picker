...
const TimePicker = ({ onChange, mode, title, style = {
    container: {},
    modal: {},
    modalContainer: {},
    ...
    const renderAndroidPicker = () => {
        if (androidModalVisible === true) {
            return (react_1.default.createElement(datetimepicker_1.default, { mode: "time", display: mode, value: date, onChange: (event, newDate) => selectDate(event, newDate) }));
        }
    };
    // Format Time
    ...
    return (react_1.default.createElement(react_native_1.View, { style: { ...styles.container, ...style.container } },
        ...
        react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => toggleModal(), style: { ...styles.fieldTextContainer, ...style.fieldTextContainer } },
            react_1.default.createElement(react_native_1.Text, { style: { ...styles.fieldText, ...style.fieldText }, numberOfLines: 1 }, formatTime(date))),
