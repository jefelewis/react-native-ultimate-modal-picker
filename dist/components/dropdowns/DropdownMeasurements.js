        ...
        if (react_native_1.Platform.OS === 'ios') {
            return (react_1.default.createElement(react_native_1.View, { style: renderContainerStyle() },
                react_1.default.createElement(react_native_1.View, { style: styles.labelContainer },
                    react_1.default.createElement(react_native_1.Text, { style: renderLabelTextStyle() }, props.title === undefined ? 'Measurements' : props.title)),
                react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => toggleModal(), style: styles.fieldTextContainer },
                    react_1.default.createElement(react_native_1.Text, { style: renderFieldTextStyle(), numberOfLines: 1 }, value ? value : 'Select')),
                react_1.default.createElement(react_native_modal_1.default, { isVisible: modalVisible, style: styles.modal, backdropOpacity: .30 },
                    react_1.default.createElement(react_native_1.View, { style: styles.modalContainer },
                        react_1.default.createElement(react_native_1.View, { style: renderModalHeaderContainerStyle() },
                            react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => pressCancel() },
                                react_1.default.createElement(react_native_1.Text, { style: renderCancelTextStyle() }, "Cancel")),
                            react_1.default.createElement(react_native_1.View, { style: styles.doneButtonContainer },
                                react_1.default.createElement(react_native_1.Button, { title: "Done", onPress: () => pressDone(), disabled: value === tempValue ? true : false, color: renderDoneTextStyle() }))),
                        react_1.default.createElement(react_native_1.View, { style: renderModalContentContainerStyle() },
                            react_1.default.createElement(picker_1.Picker, { selectedValue: tempValue !== undefined ? tempValue : value, onValueChange: (value) => selectValue(value) }, measurements.map((item, i) => {
                                return (react_1.default.createElement(picker_1.Picker.Item, { key: i, label: item.label, value: item.value, color: renderPickerItemStyle() }));
                            })))))));
        }
        // Platform: Android
        else if (react_native_1.Platform.OS === 'android') {
            return (react_1.default.createElement(react_native_1.View, { style: renderContainerStyle() },
                react_1.default.createElement(react_native_1.View, { style: styles.labelContainer },
                    react_1.default.createElement(react_native_1.Text, { style: renderLabelTextStyle() }, props.title)),
                react_1.default.createElement(picker_1.Picker, { mode: "dropdown", selectedValue: value, style: { height: 60, width: width - 16 }, onValueChange: (value) => setValue(value) }, measurements.map((item, i) => {
                    return (react_1.default.createElement(picker_1.Picker.Item, { key: i, label: item.label, value: item.value, color: renderPickerItemStyle() }));
                }))));
        }
    };
    return (react_1.default.createElement(react_1.default.Fragment, null, renderPicker()));
};
// Styles
